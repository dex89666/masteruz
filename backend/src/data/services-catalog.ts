    ...
    subcategories: [
      {
        ...
        tasks: [
          ...
          { slug: 'assemble-kitchen', name: 'Сборка кухонного гарнитура', nameUz: 'Oshxona garnituri yigʻish', nameEn: 'Assemble kitchen set', description: 'Монтаж модулей, столешницы (от 150 000 сум/пог.м)', descriptionUz: 'Modullar, stoleshnitsa oʻrnatish (150 000 soʻmdan/pog.m)', descriptionEn: 'Install modules, countertop (from 150,000 UZS/lin.m)', estimatedTime: '4-8 часов', estimatedTimeUz: '4-8 soat', estimatedTimeEn: '4-8 hours', minPrice: 150000 },
