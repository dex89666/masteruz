...
/**
 * PATCH /catalog/tasks/:id/price — обновление minPrice задачи (admin)
 */
router.patch('/tasks/:id/price', async (req, res, next) => {
  try {
...
// ═══════════════════════════════════════════
// CRUD для задач (admin/manager)
// ═══════════════════════════════════════════

/**
 * POST /catalog/tasks — создание новой задачи
 */
router.post('/tasks', async (req, res, next) => {
  try {
    ...
    // Получаем максимальный sortOrder в подкатегории
    const maxSort = await prisma.task.aggregate({
      where: { subcategoryId },
      _max: { sortOrder: true },
    });
...
/**
 * PUT /catalog/tasks/:id — полное обновление задачи
 */
...
/**
 * DELETE /catalog/tasks/:id — мягкое удаление задачи (isActive=false)
 */
...
// ═══════════════════════════════════════════
// CRUD для подкатегорий (admin/manager)
// ═══════════════════════════════════════════

/**
 * POST /catalog/subcategories — создание подкатегории
 */
...
/**
 * PUT /catalog/subcategories/:id — обновление подкатегории
 */
