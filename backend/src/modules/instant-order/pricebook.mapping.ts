...
// ─── Множители ───────────────────────────────────────────────────────────
// Заводятся нейтральными (1.000), кроме срочности: аварийный выезд ночью
// действительно стоит дороже планового. Остальные значения — рычаги для
// админа, а не готовые коэффициенты: их настраивают по факту рынка.

export const DEFAULT_MODIFIERS: SeedModifier[] = [
  { type: 'URGENCY', key: 'emergency', label: 'Авария — немедленный выезд', factor: 1.3 },
  { type: 'URGENCY', key: 'urgent', label: 'Срочно — сегодня-завтра', factor: 1.15 },
