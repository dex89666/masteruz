    ...
    problems: [
      ...
      // поэтому проблема идёт первой и слова более узкие.
      {
        ...
        solutions: [
          {
            tier: 'GOOD',
            title: 'Разборка небольшого шкафа / комода',
            description: 'Аккуратная разборка одного небольшого предмета (комод, тумба, стеллаж, навесной шкаф) с сохранением фурнитуры.',
            works: [
              { name: 'Разборка мебели', qty: 1, unit: 'шт.', unitPrice: 280_000 },
          ...
          },
          {
            ...
            description: 'Разборка крупногабаритной мебели (шкаф-купе, гардероб, гарнитур до 2.5м).',
            works: [
              { name: 'Разборка крупного шкафа', qty: 1, unit: 'шт.', unitPrice: 450_000 },
              { name: 'Снятие зеркальных дверей', qty: 2, unit: 'шт.', unitPrice: 40_000 },
          ...
          },
          {
            ...
            description: 'Полный демонтаж нескольких предметов мебели в комнате с выносом.',
            works: [
              { name: 'Разборка крупных предметов', qty: 2, unit: 'шт.', unitPrice: 400_000 },
              { name: 'Разборка мелких предметов', qty: 1, unit: 'шт.', unitPrice: 200_000 },
              { name: 'Снятие зеркал/полок', qty: 4, unit: 'шт.', unitPrice: 35_000 },
              { name: 'Вынос на лестничную клетку', qty: 1, unit: 'компл.', unitPrice: 150_000 },
            ],
            materials: [
              { name: 'Упаковка и стяжки', qty: 1, unit: 'компл.', unitPrice: 40_000 },
            ],
            days: 2,
          },
        ],
